...
!function($){
    ...
    MMGrid.prototype = {
        ...
        , _initEvents: function(){
            ...
            $("#_CustomizedQueryFormSubmit").click(function(){
              ...
              that._showLoading();
              window.subPageLoadingCallBack && window.subPageLoadingCallBack();
              ...
              $.ajax({
                ...
                cache: opts.cache
                  ...
                  window.subPageDoneCallBack && window.subPageDoneCallBack(data);
                  if(data.riskErr != null && data.riskErr != ""){
                      opts.riskErr = data.riskErr; 
                  }else{
                      opts.riskErr = "";
                  }
                  $('#_CustomizedQueryFormSubmit').removeAttr("disabled");
        ...
        , _loadAjax: function(args){
            ...
            var params_str = $("#_CustomizedQueryForm").serialize()+param_str;
            that._showLoading();
            $.ajax({
                type: opts.method,
                url: opts.url,
    ...
    $.fn.mmGrid.defaults = {
        ...
        , loadErrorText: '你的查询条件错误或查询结果不存在，请重新查询！e'
        , multiSelect: false
        , checkCol: false
        , indexCol: false
        , indexColWidth: 30
